...
$('#hdfsRemoveAccess').on('click', function() {
    bootbox.confirm({
        title: 'Remove access key?',
        message: 'Are you sure you want to remove your Amazon Simple Storage Service access key? ' +
                'This will revoke access to Amazon Hdfs for all projects you have authorized and ' +
                'delete your access token from Amazon Hdfs. Your OSF collaborators will not be able ' +
                'to write to Amazon Hdfs buckets or view private buckets that you have authorized.',
