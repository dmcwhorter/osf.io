...
<%def name="javascript_bottom()">
    ...
    <script type="text/javascript">
      ...
      window.contextVars.user = ${json.dumps(user) | n};
      window.contextVars.isRegistration = ${json.dumps(node['is_registration'] | n)};
      window.contextVars.contributors = ${json.dumps(contributors) | n};
    </script>
